...
namespace lab5
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Стратегії, визначені як функції порівняння (делегати Func<int, int, int>)
            ...
            // Виклик методу сортування з різними стратегіями (перетворюємо Func в Comparison)
            ...
            // Отримуємо словник фабричних методів
            var factory = FactoryPattern.GetShapeFactory();
            
            // Викликаємо фабрику для кожного типу фігури
            ...
            // Отримуємо базові функції-декоратори
            ...
            // Композиція декораторів через ланцюговий виклик Then
            ...
            // а) Вимірювання часу виконання сортування масиву випадкових чисел
            ...
            // б) Логування виконання математичної операції
            ...
            // в) Робота з ресурсом (симуляція безпечного підключення до БД)
            Func<string> openDb = () =>
            {
